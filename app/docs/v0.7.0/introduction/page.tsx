      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p>
            ...
            intuitive, object-oriented API for calculus operations (including <strong>complex number support</strong>) and features a
            powerful, <strong>Numba-accelerated</strong> genetic algorithm for
            finding approximate real and complex roots of polynomials of any degree.
          </p>
          <p>
          ...
          <p>
            ...
            <sub>1</sub>x<sup>n-1</sup> + ... + c<sub>n</sub>. Coefficients can be integers, floats, or complex numbers.
          </p>
        </CardContent>
      </Card>
      <DocsPagination />
